...
<body>
<c:if test="${sessionScope.userId != null && sessionScope.role == 'Customer'}">
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/customer/dashboard">Customer Panel</a>
